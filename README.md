...
Fork the GitHub repository containing the stub R files at https://github.com/devangkwatra/ProgrammingAssignment2.git to create a copy under your own account.
